...
public abstract class BaseDispatchShip<M extends BaseDispatchShip<M>> extends Model<M> implements IBean {
	...
	public M setArrivalLimit(java.lang.Integer arrivalLimit) {
		set("arrival_limit", arrivalLimit);
		return (M)this;
	}

	public java.lang.Integer getArrivalLimit() {
	...
	public M setHeavyDeclareDate(java.util.Date heavyDeclareDate) {
		set("heavy_declare_date", heavyDeclareDate);
		return (M)this;
	}

	public java.util.Date getHeavyDeclareDate() {
		return get("heavy_declare_date");
	}
	...
	public M setShipFreight(java.math.BigDecimal shipFreight) {
		set("ship_freight", shipFreight);
		return (M)this;
	}

	public java.math.BigDecimal getShipFreight() {
